...
Four tabs: **Connect**, **Create**, **Edit**, **Delete**. Navigate with `Tab` / `Shift+Tab`, pick with `Enter`, quit with `Esc` or `q`. See the [TUI keys reference](/reference/tui-keys/) for the full map.
