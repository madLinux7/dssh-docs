...
template: splash
hero:
  tagline: The only SSH manager you'll ever need.<br>CLI & TUI. Dead-simple.<br>For Linux, macOS, Windows & FreeBSD.
  image:
    file: ../../assets/dssh_stripped.svg
    alt: "dssh logo"
    class: ".hero-img"
  actions:
    - text: Get started
...
<CardGrid>
  <Card title="CLI & TUI" icon="window">
		Whether you're a CLI or TUI person, you'll feel at home.
	</Card>
  <Card title="Filter by name and groups" icon="seti:code-search">
